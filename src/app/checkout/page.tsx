...
import { trackBeginCheckout, trackPurchaseOnce, type PurchaseData } from "../../lib/ecommerceTracking";
...
const deliveryOptions = {
  ro: [
    ...
    { id: "suburbii-apropiate", label: "Livrare Codru / Băcioi / Bubuieci", fee: 70 },
  ...
  ru: [
    ...
    { id: "suburbii-apropiate", label: "Доставка в Кодру / Бэчой / Бубуечь", fee: 70 },
...
export default function CheckoutPage() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const result = await response.json() as { ok?: boolean; orderId?: string; error?: string; purchase?: PurchaseData };
      ...
      setStatus("success");
      if (result.purchase) trackPurchaseOnce(result.purchase);
      clear();
