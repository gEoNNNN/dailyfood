...
const content = {
  ro: {
    ...
    visitKicker: "VINO CU POFTĂ", visitTitle: <>MASA TA<br /><em>TE AȘTEAPTĂ.</em></>, visitText: "Treci pe la noi, ia loc sau comandă din timp și sari peste așteptare.", findUs: "NE GĂSEȘTI", address: "str. Independenței 50B", schedule: "PROGRAM", days: <>Luni–Duminică<br />11:00–23:00</>, callOrder: "Sună și comandă", seeLocation: "Vezi locația", bagText: <>MÂNCARE BUNĂ.<br />STARE BUNĂ.</>,
